...
void
copy_array(int source[], int destination[], int n)
{
	int i;
	for (i = 0; i < n; i++)
...
int
is_sorted(int array[], int n)
{
	int sorted;
	int i;
	for (sorted = 1, i = 0; sorted && i < n - 1; i++)
