...
public class TestCalcBasic extends TestCalcAbs {
    ...
    public void singleDigit() {
        for (int i = 0; i < 10; i++)
            testSequence(Integer.toString(i), new String[] {Integer.toString(i)});
    }
    ...
    public void decimalStartZeros() {
        ...
        testSequence(".005", new String[] {"0.005", ".005"});
    }
    ...
    public void negativePre() {
        testSequence(PM + "15", new String[] {"-15"});
    }
    
    @Test
    public void negativeMid() {
        testSequence("1" + PM + "5", new String[] {"-15"});
    }

    @Test
    public void negativePost() {
        testSequence("15" + PM, new String[] {"-15"});
    }
    ...
    public void overwriteResult() {
        testSequence("2+8=3", new String[] {"3"});
    }
